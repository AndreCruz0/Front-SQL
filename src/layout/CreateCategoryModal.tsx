...
import { modalTransition, modalVariants, overlayVariants } from '@/animations/modalAnimations';

export default function CreateCategoryModal() {
  const setModalState = useModalStore((state) => state.setModalState);
  const { name, setName, error, loading, onSubmit } = useCreateCategoryModal(setModalState);
      ...
      >
        ...
        >
          <Card className="max-w-md w-screen shadow-2xl border border-gray-700 bg-gray-800 text-gray-100">
            <CardContent>
              <h2 className="text-lg font-bold mb-4 text-gray-200">Criar Categoria</h2>
